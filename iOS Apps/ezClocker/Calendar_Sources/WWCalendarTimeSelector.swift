...
@objc open class WWCalendarTimeSelectorDateRange: NSObject {
   ...
   @objc open func setStartDate(_ date: Date) {
   ...
   @objc open func setEndDate(_ date: Date) {
...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    /// `WWCalendarTimeSelectorWillDismiss:selector:`
    /// `WWCalendarTimeSelectorDidDismiss:selector:`
    @objc open weak var delegate: WWCalendarTimeSelectorProtocol?
    ...
    /// - Note:
    /// Selection styles will only affect date selection. It is currently not possible to select multiple/range
    @objc open var optionSelectionType: WWCalendarTimeSelectorSelection = .single
   ...
   @objc open var optionCurrentDate = Date().minute < 30 ? Date().beginningOfHour : Date().beginningOfHour + 1.hour
    ...
    /// - Note:
    /// Selector will show the earliest selected date's month by default.
   @objc open var optionCurrentDateRange: WWCalendarTimeSelectorDateRange = WWCalendarTimeSelectorDateRange()
    
   @objc open var optionRangeOfEnabledDates: WWCalendarTimeSelectorEnabledDateRange = WWCalendarTimeSelectorEnabledDateRange()
    ...
    open var optionCalendarBackgroundColorTodayHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    ...
    open var optionClockBackgroundColorAMPMHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    ...
    open var optionClockBackgroundColorHourHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    open var optionClockBackgroundColorHourHighlightNeedle =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    ...
    open var optionClockBackgroundColorMinuteHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    open var optionClockBackgroundColorMinuteHighlightNeedle =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    open var optionClockBackgroundColorFace = UIColor(white: 0.9, alpha: 1)
    open var optionClockBackgroundColorCenter = UIColor.black
    
    open var optionButtonShowCancel: Bool = true//false
    ...
    open var optionButtonFontColorCancel =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    open var optionButtonFontColorDone =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    open var optionButtonFontColorCancelHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1).withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1).withAlphaComponent(0.25)
    ...
    open var optionTopPanelBackgroundColor =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    open var optionTopPanelFont = UIFont.systemFont(ofSize: 20)
    open var optionTopPanelFontColor = UIColor.white
    
    open var optionSelectorPanelFontMonth = UIFont.systemFont(ofSize: 30)
    open var optionSelectorPanelFontDate = UIFont.systemFont(ofSize: 30)
    open var optionSelectorPanelFontYear = UIFont.systemFont(ofSize: 30)
    open var optionSelectorPanelFontTime = UIFont.systemFont(ofSize: 30)
    ...
    open var optionSelectorPanelBackgroundColor =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1).withAlphaComponent(0.9)
    ...
    fileprivate let defaultTopPanelTitleForMultipleDates = "Select the start and end date"
    fileprivate var viewBoundsHeight: CGFloat {
        ...
        return view.bounds.height - topSpace - bottomSpace
    }
    ...
    fileprivate var tintColor : UIColor! =  UIColor(red: 88/255, green: 158/255, blue: 197/255, alpha: 1)
    ...
    open override func viewDidLoad() {
        ...
        doneButton.setAttributedTitle(NSAttributedString(string: optionButtonTitleDone, attributes: [NSAttributedString.Key.font: optionButtonFontDone, NSAttributedString.Key.foregroundColor: optionButtonFontColorDone]), for: .normal)
        cancelButton.setAttributedTitle(NSAttributedString(string: optionButtonTitleCancel, attributes: [NSAttributedString.Key.font: optionButtonFontCancel, NSAttributedString.Key.foregroundColor: optionButtonFontColorCancel]), for: .normal)
        doneButton.setAttributedTitle(NSAttributedString(string: optionButtonTitleDone, attributes: [NSAttributedString.Key.font: optionButtonFontDone, NSAttributedString.Key.foregroundColor: optionButtonFontColorDoneHighlight]), for: .highlighted)
        cancelButton.setAttributedTitle(NSAttributedString(string: optionButtonTitleCancel, attributes: [NSAttributedString.Key.font: optionButtonFontCancel, NSAttributedString.Key.foregroundColor: optionButtonFontColorCancelHighlight]), for: .highlighted)

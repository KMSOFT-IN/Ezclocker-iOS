...
- (void)assign:(ClockInfo*)clockInfo {
    ...
    NSAssert(self != clockInfo, @"clockInfo cannot be equal to self %@", msg);
    self.accuracy = clockInfo.accuracy;
    self.altitude = clockInfo.altitude;
    self.bearing = clockInfo.bearing;
    self.dateTimeEntry = clockInfo.dateTimeEntry;
    self.gpsDataStatus = clockInfo.gpsDataStatus;
    self.latitude = clockInfo.latitude;
    self.locTime = clockInfo.locTime;
    self.longitude = clockInfo.longitude;
    self.overrideLocationCheck = clockInfo.overrideLocationCheck;
    self.source = clockInfo.source;
    self.speed = clockInfo.speed;
    self.status = clockInfo.status;
}
